...
export default {
    ...
    activate(state) {
        ...
        this.subscriptions.add(atom.commands.add('atom-workspace', {
            ...
            'bookmarks:add': () => this.add({name:name, path:path}),
    ...
    add(item) {
        ...
        var path = typeof item.path !== 'undefined' ? item.path : '';
        this.bookmarksView.addItem(name, path);
    },
    ...
    listen() {
        ...
        this.subscriptions.add(editor.onDidChange(function(arg) {
            ...
            console.log(editor);
            console.log(self);
            self.add("0", editor.getLongTitle());
        }));
    },
