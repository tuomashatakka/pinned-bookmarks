...
export default {
    ...
    add(path) {
        ...
        if(typeof path === 'undefined') {
            ...
            if(typeof editor === 'undefined')
                return this.notify("Current tab is not an editor.");
    ...
    //TypeError: pane.items[index].getPath is not a function
    //    at Object.open (D:\Programming\Atom\bookmarks\lib\bookmarks.js:101:35)
    //    at HTMLSpanElement.<anonymous>
    // (D:\Programming\Atom\bookmarks\lib\bookmarks.js:87:18)
    open(path) {
